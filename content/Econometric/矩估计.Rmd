...
　　可以看出，等式(51)构建工具变量时比等式(49)多引入了一个滞后项，这导致缺失了一期的样本数据。这就又提出了一个问题，我们究竟是选择等式(49还是等式(51)的估计比较好？而矩估计(MM)法则不需要考虑这个问题，<font color=blue >MM估计可以统一所有的估计量且消去样本容量减少的缺点。</font>
...
　　Bond (2002) 认为当被解释变量的一阶滞后项系数$\rho$ 不是很大时，如$\rho <0.8$，FD-GMM 估计结果较好，而当 时，SYS-GMM 较好。
...
[^xtdpdgmm]:[xtdpdgmm](https://www.lianxh.cn/news/b6713ec0cfa7a.html)
